  ...
  return (
    <div
      ...
      className={cn(
        ...
        // shape - 8px radius לפי DESIGN_TOKENS
        "rounded-lg",
        // colors
        "bg-card text-[var(--text-primary)]",
        // border + shadow במקום ring
        "border border-[var(--border)] shadow-[var(--shadow-card)]",
        // padding default - 20px vertical
        "py-5",
        // sm variant - 12px
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[.border-b]:pb-5 [.border-b]:border-[var(--border)] group-data-[size=sm]/card:[.border-b]:pb-3",
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "px-6 py-4 group-data-[size=sm]/card:px-4 group-data-[size=sm]/card:py-3",
        className
      )}
      {...props}
    />
